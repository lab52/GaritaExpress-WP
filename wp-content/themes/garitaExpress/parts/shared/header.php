<div id="top">
	<div id="top-wp" class="wp">
		<ul>
			<li><a href="http://www.multipack.com.mx/">Rastrea tu compra</a></li>
			<li><a href="#">Contacto</a></li>
		</ul>
	</div><!-- end of #top-wp -->
</div><!-- end of #top -->
<div id="header">
	<div id="header-wp" class="wp">
		<a href="<?php echo home_url(); ?>" class="logo"><?php bloginfo( 'name' ); ?></a>
		<ul id="tels">
			<li>
				<ul class="numero">
					<li><img src="<?php bloginfo('template_directory'); ?>/_/img/tel.png" alt=""/></li>
					<li><a href="tel:6646811490" class="tel">01 (664) 681-1490</a></li>
				</ul>
			</li>
			<li>
				<ul class="numero">
					<li><img src="<?php bloginfo('template_directory'); ?>/_/img/nex.png" alt=""/></li>
					<li><a href="tel:152*15*30839" class="tel">152*15*30839</a></li>
				</ul>
			</li>
		</ul>
	</div> <!-- end of #headerners-wp -->
</div><!-- end of #header -->
<div id="menu">
	<ul id="menu-wp">
		    <li><a href="#" class="drop">Servicios</a><!-- Begin 3 columns Item -->
	    ...
	    <li><a href="#" class="drop">Promociones</a><!-- Begin 3 columns Item -->
	    ...
	    <li><a href="#" class="drop">Tiendas</a><!-- Begin 3 columns Item -->
	    ...
	    <li><a href="#" class="drop">¿Preguntas?</a><!-- Begin 3 columns Item -->
	    ...
	    <li class="menu"><a href="<?php bloginfo('siteurl'); ?>/cotizaciones" class="drop">¡Cotizaciones!</a><!-- Begin 3 columns Item -->
	    </li><!-- End 3 columns Item -->
	</ul>
</div><!-- end of #menu -->